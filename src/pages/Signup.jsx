    ...
    <main className="min-h-screen flex flex-col bg-surface-subtle"> 
      <div className="flex-1 flex items-center justify-center page-shell py-16">
        <div className="card w-full max-w-sm p-6 space-y-6">
          <div>
            <h1 className="text-display-md text-text font-semibold">Create account</h1>
            <p className="text-body-sm text-text-dim">
              We'll store your account in localStorage.
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-2">
              <label className="block text-body-sm font-medium text-text" htmlFor="email">
                Email
              </label>
              <input
                id="email"
            ...
            <div className="space-y-2">
              <label className="block text-body-sm font-medium text-text" htmlFor="password">
                Password
              </label>
              <input
                id="password"
              ...
              />
              <p className="text-body-sm text-danger-text" role="alert">
                {rhfErrors.password?.message || fieldServerError("password")}
              </p>
            </div>

            <button
              type="submit"
              className="w-full rounded-pill bg-brand-600 px-4 py-2 text-white text-sm font-medium hover:bg-brand-700 focus-visible:ring-2 focus-visible:ring-brand-500"
            >
              Sign up
            </button>
          </form>
          ...
          <div className="text-center text-body-sm text-text-dim">
            ...
            <Link
              className="text-brand-600 hover:text-brand-700 font-medium focus-visible:ring-2 focus-visible:ring-brand-500 rounded-sm"
              to="/auth/login"
            >
              Log in
            </Link>
          ...
          <div className="text-center text-body-xs text-text-dim text-[12px] leading-[16px]">
            Test login after signup: test@ticketapp.test / password123
          </div>
        </div>
      </div>
